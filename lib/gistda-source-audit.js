...
export async function auditGistdaHistoricalSources(province){
  ...
  jobs.push(query(OLD_URL,{where:oldClause,outFields:'ap_tn,ap_code,pv_tn,pv_code',returnGeometry:'false',returnDistinctValues:'true',orderByFields:'ap_code',resultRecordCount:'1000',f:'json'}));
